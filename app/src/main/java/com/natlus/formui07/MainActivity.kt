...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var btnSelftoParent: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSelftoParent.setOnClickListener {
            intentToParent()
        }
    ...
    private fun setUp() {
        ...
        btnSelftoParent = findViewById(R.id.btnSelftoParent)
    ...
    private fun intentToParent() {
        ...
        val dataPribadi = PribadiParcelize(
            Nama,
            Fakultas,
            Prodi,
            Status,
        ...
        val resultIntent = Intent(this, ParentFormActivity::class.java)
